...
RUN git clone https://github.com/suhaash02/Dextro_userbot /root/suhaash02
RUN mkdir /root/suhaash02/bin/  && mkdir root/suhaash02/mastcell_bot/main_plugs/
WORKDIR /root/suhaash02
